...
function UserSelect() {
  ...
  const navStudent = state?.student;
  console.log("Nav Student : ",navStudent);
  ...
  const [accounts] = useState(
    navStudent
      ? [
          {
            id: navStudent._id,
            fullName: navStudent.fullName,
            picture: `/23/${navStudent.picture}`, // Already a complete URL
          },
        ]
      : []
  );
  ...
  // const [selected, setSelected] = useState(navStudent || null);
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-[24px] w-full max-w-[720px] mx-auto">
      <h1 className="text-2xl font-semibold">Select a User to Mark Attendance</h1>
